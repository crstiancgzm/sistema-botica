<template>
    ...
    <q-form @submit.prevent="submit">
      <q-card-section class="q-pb-md">
        <q-input
          dense outlined v-model="form.laboratorio.nombre" :loading="form.validating"
...
import formLaboratorios from './FormLaboratorio';
...
const form = ref(null)
if (props.id) {
  form.value = useForm('put', 'api/laboratorios/' + props.id, formLaboratorios)
} else {
  form.value = useForm('post', 'api/laboratorios', formLaboratorios)
}
