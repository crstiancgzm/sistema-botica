<template>
    ...
    <q-form @submit.prevent="submit">
      <q-card-section class="q-pb-md">
        <q-input
          dense outlined v-model="form.area.nombre" :loading="form.validating"
...
const form = ref(null)
if (props.id) {
  form.value = useForm('put', 'api/areas/' + props.id, formAreas)
} else {
  form.value = useForm('post', 'api/areas', formAreas)
}
