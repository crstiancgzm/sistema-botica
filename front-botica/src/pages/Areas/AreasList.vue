<template>
  <q-dialog v-model="formAreas" persistent>
    <AreasForm
      :title="title"
      :edit="edit"
      :id="editId"
  ...
  <q-page>
    <div class="q-pa-md q-gutter-sm">
      <q-breadcrumbs>
        ...
        <q-breadcrumbs-el label="Lista de Areas" icon="mdi-key" />
      </q-breadcrumbs>
    </div>
    <q-separator />
...
import AreasForm from "src/pages/Areas/AreasForm.vue";
const $q = useQuasar();
const columns = [
  {
    name: "id",
...
async function editar(id) {
  title.value = "Editar Area";
  formAreas.value = true;
  edit.value = true;
  editId.value = id;
  const row = await AreaService.get(id);
  console.log(row);

  areasformRef.value.form.setData({area:row});
}
