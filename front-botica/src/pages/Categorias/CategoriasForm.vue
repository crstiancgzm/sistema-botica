<template>
    ...
    <q-form @submit.prevent="submit">
      <q-card-section class="q-pb-md">
        <q-input
          dense outlined v-model="form.categoria.nombre" :loading="form.validating"
...
const form = ref(null)
if (props.id) {
  form.value = useForm('put', 'api/categorias/' + props.id, formCategorias)
} else {
  form.value = useForm('post', 'api/categorias', formCategorias)
}
