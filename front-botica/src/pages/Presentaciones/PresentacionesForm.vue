<template>
    ...
    <q-form @submit.prevent="submit">
      <q-card-section class="q-pb-md">
        <q-input
          dense outlined v-model="form.presentacion.nombre" :loading="form.validating"
...
import formPresentaciones from './FormPresentacion';
...
const form = ref(null)
if (props.id) {
  form.value = useForm('put', 'api/presentaciones/' + props.id, formPresentaciones)
} else {
  form.value = useForm('post', 'api/presentaciones', formPresentaciones)
}
