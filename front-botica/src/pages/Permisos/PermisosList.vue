  ...
  <q-page>
    <div class="q-pa-md q-gutter-sm">
      <q-breadcrumbs>
        ...
        <q-breadcrumbs-el label="Lista de Permisos" icon="mdi-key" />
      </q-breadcrumbs>
    </div>
    <q-separator />
...
import PermisosForm from "src/pages/Permisos/PermisosForm.vue";
const $q = useQuasar();
const columns = [
  {
    name: "id",
...
async function editar(id) {
  ...
  permisosformRef.value.form.setData({permiso:row});
}
