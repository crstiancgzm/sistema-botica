<template>
    ...
    <q-form @submit.prevent="submit">
      <q-card-section class="q-pb-md">
        <q-input
          dense outlined v-model="form.subcategoria.nombre" :loading="form.validating"
...
import formSubcategorias from './FormCategoriaMalestar';
...
const form = ref(null)
if (props.id) {
  form.value = useForm('put', 'api/subcategorias/' + props.id, formSubcategorias)
} else {
  form.value = useForm('post', 'api/subcategorias', formSubcategorias)
}
